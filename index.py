...
df_data=pd.read_csv("C:/Users/ferna/source/repos/firstdash/dataset/cleaned_data.csv",index_col=0)
...
#Foi feita a substituição dos valores porque a existencia de um imovél com área muito grande
#fazia com que os outros parecessem pequenos no mapa.
